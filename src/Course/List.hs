...
head = foldRight (const . Full) Empty
    -- er, really should just use pattern matching on list constructors here.
    -- but have come this far without it, so am pressing on with complete disregard
    -- for common sense.
